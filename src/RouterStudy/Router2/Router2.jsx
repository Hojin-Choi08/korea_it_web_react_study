...
function Page1() {
  return (
    <>
      <div>
        <h1>Page1</h1>
        {/* 부모 Route의 path가 /*로 끝났기 때문에 여기서부터는 그 뒷 부분의 경로를 기준으로 매칭 */}
        <Routes>
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        {/* Route의 element안에서 직접 중첩 <Routes>를 정의하는 것도 가능 */}
        {/* 이 방식은 페이지 구조가 간단할 때 유용하게 사용할 수 있다 */}
        <Route
          path="/name/*"
          element={
            <Routes>
              <Route path="/name1" element={<h1>OOO</h1>} />
              <Route path="/name2" element={<h1>UUU</h1>} />
            </Routes>
          }
        />
      </Routes>
