...
function Router3() {
  //useLocation은 현재 URL의 다ㅑㅇ한 정보를 담고 있는 location 객체를 반환
  ...
  useEffect(() => {
    console.log("Query Parameter Changed");
  ...
  return (
    <div>
      ...
      <Link to={"/location/3?name=OOO"}>location3-2</Link>
      <Link to={"/location/3?name=UUU"}>location3-3</Link>
